...
//add a method to populate sample accts data
	public static Map<Integer, BankAccount> populateAccountMap() {
		...
		System.out.println("Added "
				+ accts.put(101, new BankAccount(101, "Rama", AcType.SAVING, 15000, LocalDate.parse("2023-06-01"))));
		System.out.println("Added "
		...
		System.out.println("Added " + accts.putIfAbsent(35,
				new BankAccount(35, "Mihir2", AcType.SAVING, 14000, LocalDate.parse("2023-06-01"))));
